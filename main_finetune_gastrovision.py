...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/datasets/', type=str,
                        help='dataset path')
    parser.add_argument('--official_split', default='/datasets/supervised_gastrovision.csv', type=str,
                        help='offcial split file csv')
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        path, label, set_type = self.imgs[index]
        try:
...
# categories
    data = pd.read_csv(os.path.join(args.official_split), index_col=0) 
    ...
    data_transforms = {
        'Train': transforms.Compose([
            ...
            transforms.ToTensor(),
            transforms.Normalize([0.5796, 0.3675, 0.2836], [0.2511, 0.1972, 0.1741])
        ]),
